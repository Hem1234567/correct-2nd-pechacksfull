...
const Footer = () => {
  ...
  return (
    <footer id="footer" className="relative py-20 mt-20">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              Tamil Nadu's premier hackathon bringing together the brightest
              minds to solve real-world problems through innovation and
              technology. Join us for 48 hours of coding, learning, and
              networking.
            </p>
