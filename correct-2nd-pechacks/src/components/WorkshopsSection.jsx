  ...
  const WorkshopCard = ({
    ...
    return (
      ...
      >
        {/* Workshop Title */}
        <div className="mb-6">
          <h2 className="text-2xl md:text-3xl font-black leading-tight mb-4 bg-gradient-to-r from-white via-cyan-200 to-purple-300 bg-clip-text text-transparent">
            {title}
          </h2>
            ...
            <div className="flex-1">
              ...
              {speakerLinkedIn ? (
                <a
                  ...
                  className="text-lg md:text-xl font-bold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent hover:from-pink-400 hover:via-cyan-400 hover:to-purple-400 transition-all duration-500"
                >
                  {speaker}
                </a>
              ) : (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 h-full flex flex-col">
        ...
        <div className="text-center py-6">
          <h1 className="text-4xl md:text-6xl font-black mb-3 gradient-text tracking-wider">
            WORKSHOPS
          </h1>
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-4 pb-6">
          ...
          {/* Mobile View - Day Selection Grid */}
          <div className="lg:hidden grid grid-cols-3 gap-3 mb-6">
            {[1, 2, 3, 4, 5, 6].map((day) => (
              <button
                key={day}
                onClick={() => setActiveDay(day)}
                className={`group relative overflow-hidden rounded-lg p-2 transition-all duration-500 ${
                  activeDay === day
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex flex-col items-center">
                    ...
                    <div
                      className={`w-2 h-2 mt-1 rounded-full transition-all duration-300 ${
                        activeDay === day
          ...
          {/* Desktop View - Left Panel - Day Selection */}
          <div className="hidden lg:block lg:col-span-3 card-hover-effect glassmorphism bg-gradient-to-b from-gray-900/50 to-black/70 backdrop-blur-md rounded-xl border border-gray-800/50 p-4">
          ...
          {/* Center Panel - Workshop Details (Mobile & Desktop) */}
          ...
          {/* Desktop View - Right Panel - Quick Stats */}
